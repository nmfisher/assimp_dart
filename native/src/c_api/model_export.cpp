...
namespace assimp_dart
{
    extern "C"
    {
        ...
        //
        // NOTE: the libassimp in the Filament artifacts must be built with the
        // same C++ standard library as this file (see hook/build.dart's
        // _assertSingleCppAbi). When both sides use the same runtime the
        // std::string-taking aiNode constructors would be callable; the default
        // constructors plus the inline aiString::Set(const char*) are used anyway
        // so this code stays valid for either ABI, matching thermion's
        // model_export.cpp.
        // ---------------------------------------------------------------------------
